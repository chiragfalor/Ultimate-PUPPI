...
if __name__ == "__main__":
    ...
    elif model == "modelv2" or model == "modelv2_neg" or model == "modelv2_nz0" or model == "modelv2_nz199" or model == "modelv2_orig" or model == "modelv2_newdata" or model == "modelv2_contrastive":
