...
class Net(nn.Module):
    def __init__(self, hidden_dim=32, pfc_input_dim=13, dropout=0.3, k1 = 64, k2 = 16):
        ...
        self.conv2 = TransformerConv(hidden_dim+pfc_input_dim, hidden_dim)
    ...
    def forward(self, x_pfc, x_vtx, batch_pfc, batch_vtx):
        ...
        feats1 = self.conv1(pfc_position_encoding, edge_index)
        ...
        concat_charged_feats = torch.cat([x_pfc[charged_idx], feats1[charged_idx]], dim=1)
        feats2 = self.conv2(x = (concat_charged_feats, concat_feats), edge_index=edge_index)
